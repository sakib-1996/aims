<div class="content-wrapper">
    <div class="main-content-complaint">
        ...
        <p>
            ...
            practitioners or affiliated counselling organisations, the following information will help
            guide
            you through the
            process.
            AIMS takes all complaints seriously and is committed to ensuring the complaints process is
        ...
        <div class="step-card">
            ...
            <p>If you believe there is an issue that needs to be addressed, we encourage you to first
                attempt resolution directly with the counsellor or their agency, following the
                complaints
        ...
        <div class="step-card">
            ...
            <p>If local resolution does not result in a satisfactory outcome, you may contact AIMS by
                email,
                or in writing to request a complaint form, or you can download the form from our
                website.
            </p>
            <div class="highlight">
        ...
        <div class="step-card">
            ...
            <p>When submitting your complaint, please clearly explain what you believe the practitioner
                or
            ...
            <p>We understand that the complaints process can be overwhelming. AIMS can provide a neutral
                support person to help you identify which aspects of the Code may have been breached.
                Please
        ...
        <div class="step-card">
            <h3 class="subsection-title"><span class="step-number">5</span>Initial Review and Process
            </h3>
            <p>Once your complaint is formally received, it will be referred to a director of AIMS for
                an
                initial assessment on how to proceed. The Director may consult with our independent non
                executive board members, which includes lay representatives providing guidance on
                ethical
            ...
            <ul>
                ...
                <li><strong>B. Notification to Respondent:</strong> Within 14 working days, the
                    counsellor
                    or organisation you are complaining about will be notified. They will receive a
                    summary
                ...
                <li><strong>C. Appointment of Investigator:</strong> AIMS will appoint an independent
                    ...
                    questions and may request supporting evidence. Please respond promptly and work with
                    the
                    investigator to facilitate the process. Delays can occur, but AIMS will keep you
                    informed throughout.</li>
                <li><strong>D. Investigation Report and Review:</strong> Once the investigation
                    concludes,
                    the investigator will submit a report outlining their findings and whether there is
                    a
                    prima facie case to answer. This report will be reviewed by a Pre-Hearing Assessment
                    Panel to decide whether a formal disciplinary hearing is warranted. You will be
                    informed
                    of this decision and may appeal it by providing additional information or valid
                    reasons.
                    If no satisfactory grounds for appeal are provided, the complaint will either be
                    closed
                    or proceed to a hearing.</li>
                <li><strong>E. Disciplinary Panel (if required):</strong> If a hearing is necessary, all
                    parties will be invited to participate. Evidence gathered during the investigation
                    will
                    typically be shared with both sides. The panel will make a determination and
                    communicate
                    its decision to both parties. You have the right to appeal the outcome.</li>
                <li><strong>F. Sanctions (if complaint is upheld):</strong> If the complaint is upheld,
                    AIMS
                ...
                <li><strong>G. Learning Outcomes (even if not upheld):</strong> Even where a complaint
                    is
                    not upheld, AIMS may still issue recommendations to improve practice and ensure
                    future
                    safety for clients. Lessons learned from the process may be shared anonymously with
                    all
        ...
        <p><strong>1.1</strong> This complaints procedure applies to counsellor members, registrants,
            and
            affiliated organisations of the Association of Islamic Mental Health Specialists. Guidance
            on
            the process can be found in the Guidance for people who wish to make a complaint.</p>
        <p><strong>1.2</strong> The aim of this document is to protect members of the public and uphold
            the
            reputation of the profession. This framework should normally only be used when local
            complaints
        ...
        <p><strong>1.4</strong> The aim of this document is also to promote safe and professional
            practice
        ...
        <ul>
            ...
            <li><strong>2.3</strong> A complaint should normally be lodged within three years of the
                alleged
                breach. A neutral person will be offered to help clarify issues and guide you through
                the
                process.</li>
            ...
            <li><strong>2.6</strong> Records will be kept for two years. Upheld complaints and sanctions
                may
            ...
            <li><strong>2.8</strong> The process will follow protocols set by the Association,
                administered
                by the Director.</li>
            <li><strong>2.9</strong> The Association reserves the right to initiate a complaint if
                credible
        ...
        <ul>
            <li><strong>3.1</strong> Once the complaint form is received, the Director of the
                Association
                will acknowledge it in writing, usually within seven working days. The Director will
                then
            ...
            <li><strong>3.2</strong> Following consultation with the panel, the Director may suspend a
                ...
                accreditation, or affiliation. The complaints panel is an independent body made up of
                lay
                representatives, which provides advice on ethical and professional conduct.</li>
            <li><strong>3.3</strong> Such a suspension may take effect immediately and remain in place
                until
                the investigation concludes and any decisions by the Disciplinary Panel and Appeals
                Panel
                are finalised. This authority is provided for under the Interim Sanctions Policy and may
                be
                exercised by the Director or the Disciplinary Panel after consultation with the RAP. If
                suspension is imposed, the published notice will set out its duration and whether
                practice
                may continue during this period. Before the final decision is made, the parties
                concerned
            ...
            <li><strong>3.5</strong> Within fourteen working days of receiving the complaint, the
                Director
                will write to the person named in the complaint, outlining the details and providing a
                copy
                of the submission.</li>
            <li><strong>3.6</strong> Legal advice may be sought at any stage of the investigation to
                ensure
                the process is fair and compliant with applicable requirements.</li>
            <li><strong>3.7</strong> The Director will appoint an appropriately qualified individual to
                act
            ...
            <li><strong>3.9</strong> The investigator may request relevant documents, including
                counselling
                contracts, promotional materials, qualifications, supervisor reports, and any prior
                accreditation or practice review records held by the Association. Access to client
                records
                may also be requested, but only with the written consent of the complainant or the
                client
            ...
            <li><strong>3.10</strong> Once all evidence is gathered, the investigator will present the
                findings to a Pre-Hearing Assessment Panel, typically comprising two experienced
                counsellors
                (where possible, at least one from the same therapeutic approach as the practitioner
                concerned) and one lay member. The panel will determine whether there is a case to
                answer
            ...
            <li><strong>3.11</strong> If the panel asks for additional information, the complaint will
                be
                reassessed once that information is received, and the panel will decide whether to
                proceed
            ...
            <li><strong>3.12</strong> If the panel decides to reject the complaint, both parties will be
                ...
                submitting further information or demonstrating valid grounds for a hearing. If these
                are
                not provided to a satisfactory standard, the matter will be closed.</li>
            <li><strong>3.13</strong> Where the panel accepts the complaint, the formal disciplinary
                process
                will commence.</li>
        </ul>
        ...
        <ul>
            <li><strong>4.1</strong> Once a complaint has been accepted, both parties will be notified
                in
                writing that the matter is proceeding to the Disciplinary Panel.</li>
            <li><strong>4.2</strong> All evidence submitted by either the complainant or the respondent
                will
                normally be shared with all parties involved. However, information may be withheld if
                disclosure poses a risk to any party, provided that withholding such information does
                not
                compromise fairness or transparency. The Chair will ensure that all relevant submissions
                are
            ...
            <li><strong>4.3</strong> Both parties are required to comply with the protocols of the
                Association regarding the Complaints Procedure. Failure to comply may result in
                termination
            ...
            <li><strong>4.5</strong> The Disciplinary Panel will consist of two suitably experienced
                ...
                compromise, their impartiality when approached by the Chair of AIMS (who is responsible
                for
            ...
            <li><strong>4.7</strong> The Panel will receive reports from the complaint investigator, who
                may
                also make recommendations. All parties to the complaint may attend the hearing and
                present
                their case, and may be accompanied by one person of their choosing. AIMS will not
                normally
                be responsible for any costs incurred by the parties in attending. The venue will be
                chosen
                by the Association.</li>
            <li><strong>4.8</strong> All written evidence, submissions, and witness statements must be
                submitted to the Chair no later than 28 days before the scheduled hearing. These
                documents
                will then be circulated to all parties within a reasonable timeframe prior to the
                hearing.
            </li>
            <li><strong>4.9</strong> The Chair of the Disciplinary Hearing, with appropriate advice,
                will
                decide whether any new evidence submitted on the day of the hearing will be accepted.
            </li>
            <li><strong>4.10</strong> Parties intending to call witnesses must notify the Executive
                Chair at
                least 28 days in advance, providing names and details of the witnesses. Witness
                attendance
                will only be permitted if they have provided a written statement that requires
                clarification. The Panel has the discretion to refuse witness attendance if it deems
                their
                input irrelevant or unlikely to add value to the case. Witnesses may be questioned by
                both
                the Panel and either party involved.</li>
            <li><strong>4.11</strong> If either party fails or refuses, without good reason or notice,
                to
            ...
            <li><strong>4.12</strong> The Panel will normally reach a decision on the day of the
                hearing.
                However, in line with the Standards required by the PSA for Accredited Voluntary
                Registers,
                the decision will be reviewed by the RAP to ensure the outcome is fair, proportionate,
                transparent, effective, and consistent. For further guidance on suspensions or
                reconvening
                panels for deliberation, please see the Indicative Sanctions Policy.</li>
            <li><strong>4.13</strong> AIMS will inform both the complainant and the respondent in
                writing of
                the Panel's decision within 28 days.</li>
            <li><strong>4.14</strong> AIMS aims to complete the complaints process within six months.
            </li>
        </ul>

        <h3 id="disciplinary-measures" class="subsection-title">5. DISCIPLINARY MEASURES</h3>
        <ul>
            <li><strong>5.1</strong> The Association of Islamic Mental Health Specialists (AIMS) will
                carry
                out any disciplinary measures decided by the Disciplinary Panel as appropriate. These
                may
            ...
            <li><strong>5.3</strong> A requirement for the individual or organisation to undertake
                further
            ...
            <li><strong>5.4</strong> Suspension of an individual from the Register, or suspension of
                organisational affiliation, for a specified period until the conditions set by the Panel
                are
                met.</li>
            <li><strong>5.5</strong> Permanent removal from the Register or termination of
                organisational
            ...
            <li><strong>5.8</strong> Failure to comply with any sanction will result in immediate
                termination of membership and/or removal from the Register. The decision will be
                recorded
                publicly, and the Chief Executive Officer will ensure it is enacted following the
                Panel's
                determination.</li>
        ...
        <ul>
            <li><strong>6.1</strong> Either party to a complaint may appeal against the decisions or
                sanctions of the Disciplinary Panel by writing to the Chair of the Association of
                Islamic
            ...
            <li><strong>6.2</strong> An appeal will not be granted if, after review, the Chair considers
                that:
                <ul>
                    <li>there is insufficient evidence available, or likely to become available, to
                        support
            ...
            <li><strong>6.3</strong> An appeal may be considered on any of the following grounds:
                <ul>
                    ...
                    <li>a procedural error or impropriety may have had a material effect on the Panel's
                        decision;</li>
                    <li>new evidence has become available that was not reasonably accessible at the time
                        of
                        the Disciplinary Panel hearing.</li>
                </ul>
            </li>
            <li><strong>6.4</strong> If an appeal is accepted, the Chair will appoint an Appeals Panel
                consisting of four suitably experienced individuals, including at least one lay member.
                The
                Appeals Panel will be convened specifically for this purpose, and its members will not
                be
                part of the AIMS Board, Executive, or any committee with prior involvement in the case.
            </li>
            <li><strong>6.5</strong> The Appeals Panel will consider the appeal in full, which may
                include a
                hearing where parties are given the opportunity to attend and present their case. The
                Panel
                may also seek legal or professional advice if required. Following its deliberations, the
                Chair will write to both parties to notify them of the outcome and whether the appeal
                has
                been upheld or rejected.</li>
            <li><strong>6.6</strong> The decision of the Appeals Panel is final. No further appeal will
                be
        ...
        <ul>
            <li><strong>7.1</strong> The Association of Islamic Mental Health Specialists (AIMS) will
                publish on its website the outcome of any Disciplinary or Appeal Panel where the
                complaint
                has resulted in a restriction of practice, suspension of membership, or permanent
                removal
        ...
        <div class="contact-box">
            <h3 class="text-white"><i class="fas fa-life-ring me-2"></i>Need Help with the Process?
            </h3>
            <p class="mb-0">Our team is here to assist you with the complaints process. Contact us
                for
    ...
    <div class="sidebar">
        ...
        <div class="mt-4 pt-3 border-top">
            ...
            <a href="{{ asset('AIMS-Complaint-Form.pdf') }}" class="d-block mb-2 text-decoration-none"
